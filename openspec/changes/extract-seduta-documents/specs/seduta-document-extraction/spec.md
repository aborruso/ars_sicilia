# Seduta Document Extraction

Complete extraction of all document types from ARS seduta pages, including provisional and stenographic minutes, session attachments, and agenda documents.
...
None - backward compatibility is maintained through the deprecated `resoconto_url` field.
